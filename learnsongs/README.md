...
4. Сборка с пользовательским базовым URL:
   ...
   Это настроит как базовый путь для статических ресурсов, так и базовый путь для маршрутизации React Router.

6. Аудиофайлы также будут запрашиваться с учетом базового URL.
